...
var humanizeTitleMap = {
  ...
  totalRequestBytes: 'Total request size',
  numberStaticResources: 'Number of static resources',
  htmlResponseBytes: 'HTML response size',
  cssResponseBytes: 'CSS response size',
  imageResponseBytes: 'Image response size',
  javascriptResponseBytes: 'JavaScript response size',
  otherResponseBytes: 'Other response size',
  numberJsResources: 'Number of JS resouces',
