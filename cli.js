...
function printHelp() {
  ...
  console.log('');
  console.log('Usage:');
  console.log('  $ pagespeed-insights <url> --key=<key>');
  console.log('');
  ...
  console.log('  $ pagespeed-insights <url> --key=<key> --callback=<callback> --prettyprint=<true> --userIp=<userIp> --locale=<locale> --strategy=<desktop|mobile>');
}
